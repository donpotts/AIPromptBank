...
namespace MyAIPrompt.Migrations
{
    ...
    [Migration("20250809134001_IninialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AIPromptAITag", b =>
                {
                    ...
                    b.Property<Guid>("AITagId")
                        .HasColumnType("TEXT");

                    b.HasKey("AIPromptId", "AITagId");

                    b.HasIndex("AITagId");

                    b.ToTable("AIPromptAITag");
                });
            ...
            modelBuilder.Entity("MyAIPrompt.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MyAIPrompt.Shared.Models.AIPrompt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AIPromptAITag", b =>
                {
                    ...
                    b.HasOne("MyAIPrompt.Shared.Models.AITag", null)
                        .WithMany()
                        .HasForeignKey("AITagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyAIPrompt.Models.ApplicationUser", null)
                        .WithMany()
